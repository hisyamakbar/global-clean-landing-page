...
// mx-auto px-[35px] max-w-[1440px] relative md:px-[70px]
export default function Home() {
	return (
		<div className="flex flex-col ">
			{/* Header */}
			<header className="@container">
				<div className="max-w-[1440px] mx-auto px-[35px] md:px-[70px] relative ">
					<div className="grid grid-cols-4 @6xl:grid-cols-8 @7xl:grid-cols-12 gap-x-5 lg:min-h-[744px]">
								...
								<form action="">
									<label htmlFor="findInput" className="items-center gap-2 p-3 outline outline-1 outline-[#D0D6E2] rounded-2xl flex flex-col bg-white md:flex-row md:max-w-[530px]">
										...
										<input
											id="findInput"
											type="text"
											placeholder="Find the nearest outlet near you"
											className="w-full outline-none caret-[#333333] grow h-6 selection:bg-[#3CA19D] selection:text-white bg-transparent md:text-base"
										/>
			...
			<main>
				{/* Our Service */}
				<section id="services" className="mt-[152px]">
					<div className="max-w-[1440px] mx-auto py-6 px-[35px] md:px-[70px]">
						<div className="grid grid-cols-4 gap-5 md:grid-cols-8 lg:grid-cols-12">
							...
							<div className=" px-4 py-6 col-span-full md:col-span-4 lg:col-span-3 outline outline-1 outline-[#D0D6E2] rounded-2xl text-center space-y-6 hover:shadow-2xl hover:shadow-shadow/9  bg-white group">
								...
								<a
									href="#"
									className=" px-8 py-4 text-base rounded-2xl bg-white text-[#333333] outline outline-1 outline-[#D0D6E2] flex items-center justify-center group-hover:bg-[#3CA19D] group-hover:font-bold group-hover:text-white"
								>
									Read More
								</a>
							</div>
				...
				{/* Benefits */}
				<section id="benefits" className="mt-[152px]">
					<div className="max-w-[1440px] mx-auto py-6 px-[35px] md:px-[70px]">
						<div className="flex flex-col lg:flex-row-reverse lg:gap-5 lg:max-w-[1080px] mx-auto">
							{/* accordion */}
							<div className="flex flex-col lg:w-2/4">
								...
								<Accordion type="single" collapsible defaultValue="item-1" className="space-y-6 ">
									...
									<AccordionItem value="item-3">
										...
										<AccordionContent>
											With our services, you save valuable time. No need to hassle with washing, repairing, or restoring your shoes yourself. We&apos;re here to assist you quickly and efficiently.
										</AccordionContent>
									</AccordionItem>
							...
							<div className="mt-5 overflow-hidden rounded-2xl lg:mt-0 lg:lg:w-2/4 lg:size-fit">
								<div className=" min-h-[290px] bg-[#C4C4C4] md:min-h-[530px] flex items-center justify-center">
									<Image src={shoe_1} alt="shoe photo" className="size-[276px] md:size-[432px]" />
								</div>
				...
				{/* How We Works */}
				<section id="howWeWorks" className=" mt-[200px]">
					<div className="max-w-[1440px] mx-auto py-6 px-[35px] md:px-[70px]">
						<div className="col-span-full space-y-4 text-center w-min-[290px] lg:w-max-[410px] mb-6 md:mb-14 ">
				...
				{/* Partner */}
				<section className="my-6 md:mt-24 lg:my-[152px]">
					<div className=" max-w-[1440px] mx-auto px-[35px] md:px-[70px]">
						<div className="grid grid-cols-4 gap-5 md:grid-cols-8 lg:grid-cols-12 place-items-center place-content-center">
				...
				<section id="testimonial">
					<div className="max-w-[1440px] mx-auto px-[35px] md:px-[70px]">
						<div className="grid grid-cols-4 gap-5 py-6 md:grid-cols-8 lg:grid-cols-12 md:mt-24 lg:mt-32 place-items-stretch">
				...
				{/* CTA */}
				<section id="CTA" className="my-6 md:mt-24 lg:my-[152px]">
					<div className="max-w-[1440px] mx-auto px-[35px] md:px-[70px]">
						<div className="p-10 bg-[#3CA19D] flex flex-col text-center rounded-2xl gap-6 md:max-w-[628px] lg:max-w-[1080px] mx-auto justify-center items-center">
							...
							<a className="px-8 py-4 bg-white text-[#3CA19D] rounded-[8px] font-semibold cursor-pointer">Sign-up Now</a>
						</div>
					</div>
				</section>
			</main>
			{/* Footer */}
			<footer>
				<div className="flex flex-col max-w-[1440px] mx-auto py-6 px-[35px] md:px-[70px]">
					{/* top container */}
					<div className="flex flex-col gap-5 lg:flex-row">
						<div className="flex flex-col w-full gap-3 lg:w-fit">
						...
						<div className="flex flex-wrap gap-y-5 lg:flex-auto lg:justify-end">
							{/* Summary */}
							<div className="flex flex-col min-w-[50%] md:min-w-[25%]">
							...
							{/* Social */}
							<div className="flex flex-col min-w-[50%] md:min-w-[25%] lg:min-w-0">
								<p className="text-[#333333] font-bold text-base mb-4">Summary</p>
